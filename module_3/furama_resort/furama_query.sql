...
where month(hd.ngay_lam_hop_dong) in (10,11,12) and year(hd.ngay_lam_hop_dong) = 2020 and hd.ma_dich_vu not in(select ma_dich_vu from hop_dong where month(ngay_lam_hop_dong)<=6 and year(ngay_lam_hop_dong)=2021);
